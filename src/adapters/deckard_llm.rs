...
//!
//! Functions:
//! - `DeckardLLMv1::new`: Creates a new instance of the DeckardLLMv1 adapter.
//! - `DeckardLLMv1::handle_request`: Handles an incoming HTTP request with the DeckardLLMv1 adapter.
//!
...
#[async_trait]
impl GenericInferenceEndpointAdapter for DeckardLLMv1 {

    const USER_AGENT: &'static str = "DeckardLLMv1";
