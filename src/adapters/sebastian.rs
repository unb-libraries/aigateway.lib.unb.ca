//!
//! This module provides functionality to interface with the Sebastian LLMv1 adapter.
//!
//! Functions:
...
impl SebastianLLMv1 {
    ...
    /// Request handler for the SebastianLLMv1 adapter.
    ///
    /// # Arguments
    ///
    ...
    pub async fn handle_request(
        ...
        let mut proxied_request = Request::builder()
            ...
            .header("user-agent", "SebastianLLMv1")
